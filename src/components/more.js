                        ...
                        <div className="flex flex-col lg:flex-row">
                            <div className="lg:mr-16 mb-8 lg:mb-0">
                                ...
                                <ul className="md:leading-10 text-grey-2 text-lg md:pl-5">
                                    <li className="bullet bullet-teal mb-4 md:mb-0">Led the communication department of the Sports Office of the School</li>
                                    <li className="bullet bullet-purple mb-4 md:mb-0">Designed the visual identity of the Galaorganized by the School</li>
                                    <li className="bullet bullet-pink mb-4 md:mb-0">Belonged to the Students Union office in 2017</li>
                                </ul>
                            </div>
                            <div>
