                ...
                <div>
                    <div class="flex">
                        <div class="mr-16">
                            ...
                            <ul class="list-disc leading-10 text-grey-2 text-lg pl-5">
                        ...
                        <div>
                            ...
                            <ul class="leading-10 text-grey-2 text-lg">
                    ...
                    <div class="mt-8">
                        ...
                        <ul class="leading-10 text-grey-2 text-lg">
                            <li><span class="font-bold">Programming (experienced)</span> : Java, Node.js, Typescript, Javascript, Vue.Js, Salesforce languages (Apex, Lightning)</li>
